  ...
  return (
    ...
    >
      <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28">
        ...
        <h1 className="mt-10   text-8xl max-sm:text-[72px] font-palanquin font-bold max-sm:max-sm:leading-[82px]">
          <span className="xl:bg-white xl:whitespace-nowrap relative z-10 md:pr-10">The New Arrival</span> <br />
